...
/n/groups/marks/users/aaron/RFdiffusion/env/SE3nv/bin/python /n/groups/marks/users/aaron/RFdiffusion/scripts/run_inference.py \
    inference.output_prefix=../outputs/ctnnb1/20/ \
    inference.input_pdb=../input_pdbs/6O9C.pdb \
    'contigmap.contigs=[A3-180/0 C1-9/0 59-59]' \
    'ppi.hotspot_res=[C5,C7]' \
