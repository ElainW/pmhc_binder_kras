...
python filter_backbone_orientation.py \
    --input_dirs /n/groups/marks/users/aaron/pmhc/rfdiffusion/outputs/kras/1000_filtered \
    --output_dir /n/groups/marks/users/aaron/pmhc/rfdiffusion/outputs/kras/1000_filtered/orientation_filtered \
