...
CHUNK_DIR="/n/groups/marks/users/aaron/pmhc_cp/af_init_guess/inputs/r2.5/"
OUT_DIR="/n/groups/marks/users/aaron/pmhc_cp/af_init_guess/outputs/r2.5/af2_kras"
...
python ${DL_BINDER_DESIGN_DIR}/af2_initial_guess/predict.py \
    ...
    -pae_outdir ${PAE_DIR} \
    -checkpoint_name 'r2.5.check.point'
