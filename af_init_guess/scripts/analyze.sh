...
ls /n/groups/marks/users/aaron/pmhc/af_init_guess/outputs/af2_kras/kras_scores_*.sc | wc -l

# Check for any failed chunks
# for log in /n/groups/marks/users/aaron/pmhc/af_init_guess/logs/af2_ig_kras_*.log; do
...
python analyze_af2_scores.py \
    ...
    --silent_dir /n/groups/marks/users/aaron/pmhc/af_init_guess/outputs/af2_kras/ \
