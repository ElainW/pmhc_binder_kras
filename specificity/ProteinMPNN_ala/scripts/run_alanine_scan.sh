...
/n/groups/marks/users/aaron/pmhc/envs/dl_binder_design/bin/python generate_mpnn_pepscan_csv.py \
...
#     --output_dir /n/groups/marks/users/aaron/pmhc/specificity/ProteinMPNN_ala/outputs/ \
#     --use_mt_structure 0 \
