...
sbatch -p short -c 1 -t 0-2:00 --mem=10G -o ${slurm_dir}/af3-nomsa-design-%j.out -e ${slurm_dir}/af3-nomsa-design-%j.err -J af3-nomsa-design --wrap="
...
sbatch -p short -c 1 -t 0-2:00 --mem=10G -o ${slurm_dir}/af3-author-%j.out -e ${slurm_dir}/af3-author-%j.err -J af3-author-design --wrap="
python fastrelax_designs_af3.py \
...
# step 0: run fastrelax
sbatch -p priority -c 1 -t 0-12:00 --mem=10G -o ${slurm_dir}/af3-r2-%j.out -e ${slurm_dir}/af3-r2-%j.err -J af3-r2-design --wrap="
python fastrelax_designs_af3.py \
